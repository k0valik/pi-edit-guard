// Settings registry for pi extensions.
//
// Extensions declare their settings via `registerSettings()` during their
// factory function. The settings UI reads them via `getRegisteredSettings()`.
...
export interface SettingsSection {
  /** Extension identifier — e.g. "bash-timeout", "insights" */
  id: string;
