...
import { readBooleanEnv, readPositiveIntEnv } from "../src/config.js";
import { shellQuote, splitShellBoundary, stripQuotes, tokenizeCommand } from "../src/shell.js";

describe("pi-base utilities", () => {
  describe("types", () => {
    it("isRecord should identify Record<string, unknown> values", async () => {
      const { isRecord } = await import("../src/types.js");
